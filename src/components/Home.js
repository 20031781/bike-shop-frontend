    ...
    <div className="home">
        <div>
            <div className="home-heading">
                <a href={"#home-content"}>
                    <h2>IL SITO IDEALE PER GLI APPASSIONATI DI MOTO</h2>
                </a>
            </div>
            ...
            <div className="home-content" id="home-content">
                <h2>Concept< /h2>
                <p>
                    Il sito ha l&apos;obiettivo di fornire un catalogo di moto che si
                    possono comprare o eventualmente noleggiare. <br/>
                    L&apos;utente che visita il sito senza loggarsi vedrà solo il catalogo delle
                    moto disponibili quindi... <br/> <br/>
                    Che aspetti, registrati oppure accedi al sito per
                            ...
                            <a className="social-link social-link--dribbble" id="dribbble">
                                <svg className="social-svg" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <g className="social-group" fill="none" fillRule="evenodd">
                                        <circle className="social-group__outline" stroke="#000" strokeWidth="20"
                                                cx="300"
                                                cy="300" r="262.5"/>
                                        <circle className="social-group__inner-circle" fill="#DA5988" cx="300" cy="300"
                                                r="252.5"/>
                                ...
                                <svg className="social-svg" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <g className="social-group" fill="none" fillRule="evenodd">
                                        ...
                                        <circle
                                            ...
                                            fill="url(#simpleInsta)" cx="300" cy="300" r="252.5"/>
                                        <path className="social-group__icon"
